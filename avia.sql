...
where f.departure_airport = 'AAQ' ---аэропорт Анапы
      and f.actual_departure>= '2016-12-01'
      and f.actual_departure< '2017-03-01'
group by 1,2
---
/*
итоги:
...
select date_trunc('month',actual_departure), 
